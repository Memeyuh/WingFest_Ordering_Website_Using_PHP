            ...
            <ul class="list-unstyled component m-0">
                ...
                <li class="dropdown">
                    ...
                    <ul class="collapse list-unstyled menu" id="homeSubmenu2">
                        <li class="active"><a href="admin-prod.php" style="padding-left: 2rem;"><i
                                    class="material-icons">list</i>All
                                Products</a>
                        </li>
                        <li><a href="#addProdModal" data-toggle="modal" style="padding-left: 2rem;"><i
                                    class="material-icons">add</i>Add
                                Products</a>
                        </li>
                    </ul>
        ...
        <div id="content">
            ...
            <div class="main-content">
                ...
                <div class="row">
                            ...
                            <table class="table table-striped table-hover" id="dataTable" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" style="font-weight: bolder">Product Name</th>
                                        <th scope="col" style="font-weight: bolder">Category</th>
                                        <th scope="col" style="font-weight: bolder">Availability</th>
                                        <th scope="col" style="font-weight: bolder">Price</th>
                                        <th scope="col" style="font-weight: bolder">Description</th>
                                        <th scope="col" style="font-weight: bolder">Image</th>
                                ...
                                <tbody id="dataTbl">
                                    ...
                                    $sql = "SELECT * FROM products ORDER BY Product_Name $sort_option";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="<?php echo "Images/" . $row['image']; ?>"
                                                    style="width: 100px; height: 70px;" alt="Image">
                                            </td>
                                            <td>
                                                <a href="#editProdModal" class="editBtn" style="color: #ffc107;"
                                                    data-toggle="modal">
                                                    <i class="material-icons" data-toggle="tooltip" title="Edit"
                                                        style="font-size: 1.5rem;">&#xE254;</i>
                                                </a>

                                                <a href="#deleteProdModal" class="deleteBtn" style="color: #f44336;"
                                                    data-toggle="modal">
                    ...
                    <!----- ADD MODAL ------>
                    <div class="modal fade" tabindex="-1" id="addProdModal" role="dialog">
                        <div class="modal-dialog" role="document" style="max-width: 700px; max-height: 550px">
                            <div class="modal-content">
                                ...
                                <form action="scrud.php" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body"
                                        style="display: flex; flex-direction: row; margin: 20px 0 0 0;">
                                        <div class="form-group"
                                            style="text-transform: uppercase; width: calc(100% / 1 - 0px)">
                                            <label>Product Name</label>
                                            <input type="text" name="pname" class="form-control" minlength="3"
                                        ...
                                        <div class="form-group">
                                            <label>Price</label>
                                            <input type="number" class="form-control" name="price" min="0" max="5000"
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <?php
                                            $sql = mysqli_query($conn, "SELECT * FROM categ");
                                            ?>
                                        ...
                                        <div class="modal-footer"
                                            ...
                                            <button type="submit" name="createProd"
                    ...
                    <!----- EDIT MODAL ----->
                    <div class="modal fade" tabindex="-1" id="editProdModal" role="dialog">
                        <div class="modal-dialog" role="document" style="max-width: 700px; max-height: 550px">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" id="image" accept=".jpg, .jpeg, .png"
                                                class="form-control" value="Images/<? echo $row['image']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <?php
                                            $sql = mysqli_query($conn, "SELECT * FROM categ");
                    ...
                    <!----- DELETE MODAL ----->
                    <div class="modal fade" tabindex="-1" id="deleteProdModal" role="dialog" aria-hidden="true">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(response, function (key, value) {
                            $('#edit_id').val(value['Prod_ID'])
                            $('#pname').val(value['Product_name']);
